...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('solution_type', models.CharField(choices=[('image', 'Image Analysis'), ('document', 'Document Analysis'), ('text_chat', 'Text Chat')], default='image', max_length=20)),
                ('image_url', cloudinary.models.CloudinaryField(blank=True, max_length=255, null=True, verbose_name='ai_content')),
                ...
                ('confidence_score', models.DecimalField(blank=True, decimal_places=2, max_digits=3, null=True)),
                ('processing_time', models.IntegerField(blank=True, null=True)),
                ('title', models.CharField(default='AI Solution', max_length=255)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('message_type', models.CharField(choices=[('text', 'Text'), ('image', 'Image'), ('file', 'File'), ('document_share', 'Document Share'), ('system', 'System')], default='text', max_length=20)),
                ...
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
                ('room', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='home.chatroom')),
                ('shared_document', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='home.document')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('report_type', models.CharField(choices=[('spam', 'Spam'), ('inappropriate', 'Inappropriate Content'), ('copyright', 'Copyright Violation'), ('harassment', 'Harassment'), ('other', 'Other')], default='other', max_length=50)),
                ...
                ('solution', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='home.aiimagesolution')),
                ('study_list', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='home.studylist')),
            ],
            options={
        ...
        migrations.AddIndex(
            model_name='document',
            index=models.Index(fields=['status', 'is_public', '-view_count'], name='documents_status_228034_idx'),
        ),
        migrations.AddIndex(
            model_name='document',
            index=models.Index(fields=['course', '-created_at'], name='documents_course__20431c_idx'),
        ),
        migrations.AddIndex(
            model_name='document',
            index=models.Index(fields=['university', '-created_at'], name='documents_univers_713098_idx'),
        ),
        ...
        migrations.AddIndex(
            model_name='chatroom',
            index=models.Index(fields=['is_active', 'room_type', '-created_at'], name='chat_rooms_is_acti_bb4c57_idx'),
        ),
        migrations.AddIndex(
            model_name='chatroom',
            index=models.Index(fields=['course', '-created_at'], name='chat_rooms_course__110346_idx'),
        ),
        migrations.AddIndex(
            model_name='chatroom',
            index=models.Index(fields=['university', '-created_at'], name='chat_rooms_univers_bedb65_idx'),
        ),
        migrations.AlterUniqueTogether(
            name='userreport',
            unique_together={('reporter', 'solution')},
        ),
    ]
